...
5. **Подписи сегментов/стенок на cine** (P1) — как «БазПерг/СрЛат» у вендора.
...
STE-файлов, бенчмарки, где лежат документы и данные.
