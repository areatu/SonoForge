...
> **Версия:** rev.5 (rev.4 + §0 «что сделано / что осталось», актуализация §5.2 на 2026-09-11, §5.3 «Осталось сделать», §5.4 «Как продолжить»)
> **Дата:** 2026-09-11
...
6. **GLS в протокол исследования и отчёт** (P1).
