...
> **Версия:** rev.5 (rev.4 + актуализация §5.2 на 2026-09-11, новые §5.3 «Осталось сделать» и §5.4 «Как продолжить»)
> **Дата:** 2026-09-11
...
> 4. Добавлены §5.3 «Осталось сделать» (упорядоченная очередь с критериями приёмки и оценками) и
>    §5.4 «Как продолжить» (окружение, тестовый свип, бенчмарки, артефакты) — для следующей сессии.
