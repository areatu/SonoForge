...
| F6 | **Сегментные значения расходятся сильнее глобального**: RMS 9.0 п.п. (20 дБ), 15.6 п.п. (10 дБ), 35.9 п.п. (0 дБ) при воротах 2.5 п.п. | на чистом уровне RMS теперь 1.07–2.39 п.п. (все ≤2.5) → **закрыто для чистых клипов**; на 10 дБ RMS 4.3–16.4, на 0 дБ 14–27 → **остаётся шумовая часть**, честно помечается QC | **частично закрыто** 2026-09-11 |
...
(0–10 дБ): там ошибка честно видна в QC (`review`/`invalid`), но по абсолютной точности гейты пока не
выполняются — это следующая работа, вместе с UI (фаза 4).
