...
Run: `/home/areatu/ECHO2026/.venv/bin/python -m pytest tests/unit/test_maximum_calibration_regression.py -v`
Expected: All PASS
...
Write your report to `/home/areatu/ECHO2026/docs/superpowers/plans/task-6-report.md` with:
